...
# RS encode les blocs de données AVANT l'encapsulation CCSDS
packets = send_image(image_path, preprocessor=rs.encode)
...
reconstruct(
    parsed, "../data/output/received_image_with_jamming_&_rs.bmp", discardInvalid=False
)
